...
router.route("/reject").post(protectAdminRoute, isAdmin, rejectChangeUser);
router.route("/approve").post(protectAdminRoute, isAdmin, approveChangeUser);
router.route("/list").get(protectAdminRoute, isAdmin, getAllChangeUsers);
router.route("/detail/:id").get(protectAdminRoute, isAdmin, getChangeUsersById);
