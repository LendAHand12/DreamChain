      ...
      <div className="w-full md:p-24 py-24 px-10 space-y-10">
        <div>
          <h1 className="text-3xl font-bold mb-4">
            DreamChain - MEMBER’S GUIDELINES
          </h1>
          <p className="mb-4 font-semibold">
            DreamChain is your Path to Prosperity
          </p>
          <p className="">
            ...
            <ul className="grid gap-4 list-disc">
              <li className="flex items-start gap-6">
                <span>
                  ...
                  Recruit{' '}
                  <span className="font-semibold">
                    2 direct members within 15 days
                  </span>{' '}
              ...
              <li className="flex items-start gap-6">
                <span>
                  <span className="font-semibold">• Volume Achievements:</span>
                  Members who achieve volume are rewarded with exclusive
